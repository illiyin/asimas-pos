...
<div class="row" style='min-height:80px;'>
  ...
  <div class="row">
    <h3><strong>Master</strong> - Customer Level</h3>
  </div>
...
<script type="text/javascript">
  ...
  $("#myform").on('submit', function(e){
    ...
    var action = "<?php echo base_url('Master_customer_level/Master/add')?>/";
    if ($("#id").val() != ""){
      action = "<?php echo base_url('Master_customer_level/Master/edit')?>/";
	...
	function deleteData(element){
		...
		$.ajax({
          type: 'post',
          url: '<?php echo base_url('Master_customer_level/Master/delete'); ?>/',
