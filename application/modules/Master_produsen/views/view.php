...
// initialize datatable
  ...
  function get_kota(){
  	...
  	$.ajax({
  	   url :"<?php echo base_url('Master_produsen_bahan/Master/get_kota')?>/",
  	   type : "GET",
  ...
  $("#myform").on('submit', function(e){
    ...
    var action = "<?php echo base_url('Master_produsen_bahan/Master/add')?>/";
    if ($("#id").val() != ""){
      action = "<?php echo base_url('Master_produsen_bahan/Master/edit')?>/";
	...
	function deleteData(element){
		...
		$.ajax({
          type: 'post',
          url: '<?php echo base_url('Master_produsen_bahan/Master/delete'); ?>/',
