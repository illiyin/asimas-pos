...
<div class="row">
    <h3><strong>Produk</strong> - Merk</h3>
  </div>
      ...
      <table id="TableMain" class="table table-striped table-bordered" cellspacing="0" width="100%">
          <thead>
              <tr>
                  ...
                  <th class="text-center">Nama Merk Produk</th>
 ...
 <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Tambah Merk Produk</h4>
      </div>
           ...
           <div class="row">
             <div class="col-sm-12">
                <div class="form-group">
                 <label for="nama">Nama Merk Produk</label>
                 <input type="text" name="nama" maxlength="50" Required class="form-control" id="nama" placeholder="Nama Merk Produk">
                 <input type="hidden" name="id" maxlength="50" Required class="form-control" id="id" placeholder="ID Merk Produk">
               </div>
             </div>
        </div>
...
<script type="text/javascript">
  ...
  function showAdd(){
    $("#myModalLabel").text("Tambah Merk Produk");
    $("#id").val("");
    $("#nama").val("");
  ...
  function showUpdate(i){
    $("#myModalLabel").text("Ubah Merk Produk");
  ...
  $("#myform").on('submit', function(e){
    ...
    var action = "<?php echo base_url('Produk_merk/Master/add')?>/";
    if ($("#id").val() != ""){
      action = "<?php echo base_url('Produk_merk/Master/edit')?>/";
	...
	function deleteData(element){
		...
		$.ajax({
          type: 'post',
          url: '<?php echo base_url('Produk_merk/Master/delete'); ?>/',
